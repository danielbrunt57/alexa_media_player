...
async def async_setup(hass, config, discovery_info=None):
    ...
    if DOMAIN in config:
        ...
        _LOGGER.error(
            "YAML configuration of Alexa Media Player is now deprecated."
            "Please remove \"alexa_media:\" from your configuration.yaml file, "
            "restart Home Assistant and use the UI to configure it. "
